...
FILES = ./build/kernel.asm.o ./build/kernel.o ./build/idt.asm.o ./build/idt.o ./build/memory.o ./build/io.asm.o ./build/console.o ./build/string.o ./build/heap.o ./build/kheap.o ./build/paging.o
INCLUDES = -I./src
